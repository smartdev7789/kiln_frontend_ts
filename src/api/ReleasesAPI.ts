...
export const getAppReleases = async (token: string, appId: string) => {
  ...
  const projection =
    '&projection={"regions":1,"builds":1}&embedded={"builds":1}';
 ...
 * @returns
 */
export const getAppRelease = async (
  token: string,
  appId: string,
  releaseId: string
) => {
 ...
 * @returns
 */
export const deleteAppRelease = async (
  token: string,
  appId: string,
  releaseData: Release,
  etag: string
 ...
 * @returns
 */
export const deleteReleaseBuild = async (
  token: string,
  appId: string,
  releaseId: number,
  buildId: number
